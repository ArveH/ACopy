...
namespace ACopyLibTest
{
    ...
    public class TestCreateTableFromXmlSqlServer: TestCopyLibBase
    {
        ...
        [TestMethod, TestCategory("SqlServer")]
        public void TestOldTextCol_When_SqlServer()
        {
            CreateTable(ColumnTypeName.OldText, 0, 0, 0, false, "", null);
            VerifyColumnType("text", null, null, null);
        }
        ...
        [TestMethod, TestCategory("SqlServer")]
        public void TestSmallMoneyCol_When_SqlServer()
        {
            CreateTable(ColumnTypeName.SmallMoney, 0, 0, 0, false, "", null);
            VerifyColumnType("smallmoney", null, null, null);
        }

        [TestMethod, TestCategory("SqlServer")]
        public void TestTimeCol_When_SqlServer()
        {
